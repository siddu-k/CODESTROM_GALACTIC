//This code is outdated. For the latest version of the project, check here: https://codepen.io/isladjan/full/vEBdwOP
...
function init() {
 ...
 function limitFPS(interval) {
    requestAnimationFrame(limitFPS.bind(this, interval));
